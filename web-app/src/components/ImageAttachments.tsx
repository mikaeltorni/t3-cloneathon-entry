              ...
              <div key={image.id} className="relative group">
                  ...
                  {isUploading && !image.url ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <div className="flex flex-col items-center gap-1">
                        ...
                        <div className="text-xs text-red-600 text-center px-1">
                          Error
                        </div>
                      </div>
                    </div>
                    ...
                    <>
                      ...
                      {isUploading && (
                        <div className="absolute inset-0 bg-blue-500 bg-opacity-20 flex items-center justify-center">
                          <div className="bg-white bg-opacity-90 rounded-full p-1 flex items-center gap-1">
                ...
                <button
                  ...
                  className={`absolute -top-2 -right-2 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold transition-opacity ${
                    error ? 'bg-red-500 hover:bg-red-600 text-white opacity-100' :
                    isUploading ? 'bg-blue-500 hover:bg-blue-600 text-white opacity-80 hover:opacity-100' :
                ...
                <div className="mt-1 text-xs text-gray-500 truncate">
                  ...
                  {error && (
                    <p className="text-red-600 text-xs mt-1 truncate" title={error}>
                      {error}
                    </p>
                  )}
                </div>
